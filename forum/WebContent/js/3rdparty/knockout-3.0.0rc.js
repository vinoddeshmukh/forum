            ...
            "function" === typeof require && "object" === typeof exports && "object" === typeof module ? q(module.exports || exports) : "function" === typeof define && define.amd ? define(["exports"], q) : q(y.ko = {})
                ...
                a.a = function () {
                    ...
                    return {
                        ...
                        Vb: function (b) {
                            b = a.a.Q(b);
                            for (var c = w.createElement("div"), f = 0, d = b.length; f < d; f++) c.appendChild(a.M(b[f]));
                            return c
                        },
                        Ya: function (b, c) {
                            for (var f = 0, d = b.length, e = []; f < d; f++) {
                                var h = b[f].cloneNode(!0);
                                e.push(c ? a.M(h) : h)
                            }
                            return e
                        },
                        ...
                        nb: function (b,
                            ...
                            if (0 < f.length) {
                                for (var d = f[0], e = d.parentNode, h = 0, n = c.length; h < n; h++) e.insertBefore(c[h], d);
                                h = 0;
                                for (n = f.length; h < n; h++) a.removeNode(f[h])
                            }
                        },
                        $: function (a, b) {
                            if (a.length) {
                        ...
                        ec: function (b, c) {
                            for (var f = [], d = (b || "").split(c), e = 0, h = d.length; e < h; e++) {
                                var n = a.a.la(d[e]);
                                "" !== n && f.push(n)
                            }
                            return f
                        ...
                        Ma: function (b, c) {
                            ...
                            !d || 3 != d.nodeType || a.e.nextSibling(d) ? a.e.S(b, [w.createTextNode(f)]) :
                                d.data = f;
                            a.a.Jb(b)
                        },
                        pb: function (a, b) {
                        ...
                        ab: function (b, c) {
                            for (var f =
                                a.a.Q(b.getElementsByTagName("input")).concat(a.a.Q(b.getElementsByTagName("textarea"))), d = "string" == typeof c ? function (a) {
                                        return a.name === c
                                    } : function (a) {
                                        return c.test(a.name)
                                    }, e = [], h = f.length - 1; 0 <= h; h--) d(f[h]) && e.push(f[h]);
                            return e
                        },
                        Wb: function (b) {
                        ...
                        Xb: function (c, d, f) {
                            f = f || {};
                            var e = f.params || {}, h = f.includeFields || this.$a,
                                g = c;
                            if ("object" == typeof c && "form" === a.a.v(c))
                                for (var g = c.action, n = h.length - 1; 0 <= n; n--)
                                    for (var r = a.a.ab(c, h[n]), v = r.length - 1; 0 <= v; v--) e[r[v].name] = r[v].value;
                            d = a.a.c(d);
                ...
                a.a.C = new function () {
                    ...
                    return {
                        ...
                        mb: function (c, e) {
                            var m = b(c, !1);
                            m && (a.a.ia(m, e), 0 == m.length && a.a.f.set(c, d, q))
                        },
                        M: function (b) {
                    ...
                    a.a.Fa = function (b) {
                        ...
                        if ("undefined" != typeof u)
                            if (u.parseHTML) c = u.parseHTML(b) || [];
                                ...
                                ] || (!d.indexOf("<td") || !d.indexOf("<th")) && [3, "<table><tbody><tr>", "</tr></tbody></table>"] || [0, "", ""];
                ...
                a.ba.fn = {
                    remove: function (b) {
                        for (var c = this.t(), d = [], e = "function" != typeof b || a.J(b) ? function (a) {
                                return a === b
                            } : b, g = 0; g < c.length; g++) {
                            var h = c[g];
                    ...
                    destroy: function (b) {
                        var c = this.t(),
                            d = "function" != typeof b || a.J(b) ? function (a) {
                                return a === b
                            } : b;
                        this.O();
                        ...
                        b.Xa = function (a, b, c) {
                            ...
                            if (d && !g) {
                                ...
                                case "splice":
                                    ...
                                    for (var l = 1 === n ? l : Math.min(b + (c[1] || 0), l), n = b + n - 2, r = Math.max(l, n), v = 2; b < r; ++b, ++v) b < l && h("deleted", a[b], b), b < n && h("added", c[v], b);
                                    break;
                                default:
                                    return
                                }
                ...
                (function () {
                    ...
                    function c(b, c) {
                        if (b instanceof Array) {
                            ...
                            for (d in b)("toJSON" === d ||
                                "function" !== typeof b[d] || a.J(b[d])) && c(d)
                    }
                    ...
                    return {
                        ...
                        ka: function (e, f) {
                            function g(b, f) {
                                ...
                                if (r && r.preprocess ? f = r.preprocess(f,
                                    b, g) : 1) {
                                    if (r = k[b]) e = f, 0 <= a.a.l(c, e) ? e = !1 : (r = e.match(d), e = null === r ? !1 : r[1] ? "Object(" + r[1] + ")" + r[2] : e), r = e;
                        ...
                        if (m) {
                            ...
                            a.a.n(g, function (c) {
                                var d = c.bb.init,
                                    e = c.bb.update,
                                    k = c.key;
                                if (8 === b.nodeType && !a.e.P[k]) throw Error("The binding '" +
                                    k + "' cannot be used with virtual elements");
                                try {
                ...
                (function () {
                    a.d.checked = {
                        ...
                        init: function (b, c, d) {
                            ...
                            function h() {
                                var d = a.a.c(c());
                                b.checked = f ? 0 <= a.a.l(d, e()) : k ? d :
                                    e() === d
                            }
                            var k = "checkbox" == b.type,
                                m = "radio" == b.type;
                            if (k || m) {
                                var f = k && a.a.c(c()) instanceof Array,
                                    p = f ? e() : q,
                                    s = m || f,
                                    l = !1;
                ...
                a.d.css = {
                    update: function (b, c) {
                        var d = a.a.c(c());
                        "object" == typeof d ? a.a.L(d, function (c, d) {
                            d = a.a.c(d);
                            a.a.ma(b, c, d)
                        }) : (d = String(d || ""), a.a.ma(b, b.__ko__cssValue, !1), b.__ko__cssValue = d, a.a.ma(b,
                            d, !0))
                    }
                };
                a.d.enable = {
                            ...
                            "string" == typeof k && a.a.r(b, k, function (b) {
                                ...
                                if (h) {
                                    try {
                                        ...
                                        "Bubble") && (b.cancelBubble = !0, b.stopPropagation && b.stopPropagation())
                                }
                            })
                        })
                    }
                ...
                a.d.hasfocus = {
                    ...
                    update: function (b, c) {
                        var d = !! a.a.c(c());
                        b.__ko_hasfocusUpdating || b.__ko_hasfocusLastValue === d || (d ? b.focus() : b.blur(), a.i.p(a.a.da, null, [b, d ? "focusin" : "focusout"]))
                    }
                };
                a.g.U.hasfocus = !0;
                ...
                a.d.options = {
                    ...
                    update: function (b, c, d) {
                        function e() {
                            return b.selectedOptions || a.a.ga(b.options, function (a) {
                                return a.selected
                            })
                        }
                        ...
                        var m = d.get("optionsIncludeDestroyed"),
                            f = {}, p;
                        p = b.multiple ? a.a.ha(e(), a.k.o) :
                            0 <= b.selectedIndex ? [a.k.o(b.options[b.selectedIndex])] : [];
                        if (c) {
                        ...
                        a.a.Ja(b, s, function (b, c, e) {
                            ...
                            b === f ? (a.a.Ma(c, d.get("optionsCaption")), a.k.na(c, q)) : (e = g(b, d.get("optionsValue"), b), a.k.na(c, a.a.c(e)), b = g(b, d.get("optionsText"), e), a.a.Ma(c, b));
                            return [c]
                        }, null, c);
                ...
                (function () {
                    ...
                    a.d.template = {
                        init: function (b, c) {
                            var d = a.a.c(c());
                            "string" == typeof d || d.name ?
                                a.e.Z(b) : (d = a.e.childNodes(b), d = a.a.Vb(d), (new a.m.W(b)).nodes(d));
                            return {
                                controlsDescendantBindings: !0
                            }
                        },
                ...
                a.a.ra = function () {
                    function a(b, d, e, g, h) {
                        var k = Math.min,
                            ...
                            t, u, w;
                        for (p = 0; p <= q; p++)
                            for (u = t, f.push(t = []), w = k(n, p + r), l = m(0, p - 1); l <= w; l++) t[l] = l ? p ? b[p - 1] === d[l - 1] ? u[l - 1] : k(u[l] || v, t[l - 1] ||
                                v) + 1 : l + 1 : p + 1;
                        k = [];
                        m = [];
                        r = [];
                ...
                (function () {
                    ...
                    a.a.Ja = function (d, e, g, h, k) {
                        ...
                        f(h.beforeMove, z);
                        a.a.n(u, h.beforeRemove ? a.M : a.removeNode);
